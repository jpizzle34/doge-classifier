...
# PURPOSE:  This set of functions can be used to check your code after
#           programming
...
#           your code. See the docstrings below each function for details on
#           how to use the function within your code.
#
##
...
def check_creating_pet_image_labels(petlabels_dic):
    ...
    pairs in your petlabels_dic dictionary. Assumes you defined the
    petlabels_dic
...
def check_classifying_labels_as_dogs(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # Increments Match counter
            n_match += 1
            print("Real: %-26s   Classifier: %-30s  PetLabelDog: %1d\
                ClassLabelDog: %1d"
...
def check_calculating_results(results_dic, results_stats):
    ...
    by the calculates_results_stats() function), then prints the same
    statistics
    ...
    print("N Images: %2d  N Dog Images: %2d  N NotDog Images: %2d \nPct Corr\
        dog: %5.1f Pct Corr NOTdog: %5.1f  Pct Corr Breed: %5.1f"
